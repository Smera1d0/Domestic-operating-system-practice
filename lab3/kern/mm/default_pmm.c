...
default_alloc_pages(size_t n)
{
    ...
    //         list_add_before(&(page->page_link), &(rest->page_link));
    //     }
    ...
    // return page;
    /////////////////////BFMA/////////////////////////////
    list_entry_t *le = &free_list, *best = NULL;
    struct Page *page = NULL;
    ...
    if (best != NULL)
    {
        ...
        if (page->property > n)
        {
            ...
            rest->property = page->property - n; //
            SetPageProperty(rest);
            list_add(page->page_link.prev, &(rest->page_link));
        }
        list_del(&(page->page_link));
        page->property = 0;
        ClearPageProperty(page);
